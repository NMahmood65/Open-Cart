...
class Test extends authCommand_1.AuthCommand {
    async run() {
        ...
        const { location: runLocation, 'private-location': privateRunLocation, grep, tags: targetTags, env, 'env-file': envFile, list, timeout, verbose: verboseFlag, reporter: reporterFlag, config: configFilename, record: shouldRecord, 'test-session-name': testSessionName, } = flags;
    ...
    listChecks(checks) {
        ...
        for (const [sourceFile, checks] of checkFilesMap) {
            ...
            for (const check of checks) {
                (0, util_2.printLn)(indentString((0, util_2.formatCheckTitle)(util_2.CheckStatus.RUNNING, check), 2));
            }
        }
    }
}
